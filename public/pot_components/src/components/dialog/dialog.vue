<style lang="stylus" rel="stylesheet/stylus">
    ...
    .pot-dialog-btn
        ...
        padding: 17px 10px
        margin: 0
        font-size: $dialog-btn-font
        line-height: 1
        text-align: center
        text-decoration: none
        color: $dialog-negative-color
        ...
        <pot-popup
            ...
            <div class="pot-dialog-main">
                ...
                <div :class="containerClass">
                    ...
                    <div v-if="!isSelect&&!isSelects" class="pot-dialog-content">
                        <slot name="content">
                    ...
                    <div class="selects_list" v-if="isSelects">
                        <div :class="{active:hasSelects.indexOf(index)!=-1}" @click="onSelects(index)"
                             class="select_item" v-for="(item,index) of selects">
          		<span class="icon">
          			<svg fill="#fff" t="1541034906007" style="" viewBox="0 0 1397 1024" version="1.1" p-id="1046"
                         width="272.8515625" height="200">
                    ...
                    <div class="select_list" v-if="isSelect">
                        <div :class="{active:active==index}" @click="active=index" class="select_item"
                             v-for="(item,index) of selects">
          		<span class="icon">
          			<svg fill="#fff" t="1541034906007" style="" viewBox="0 0 1397 1024" version="1.1" p-id="1046"
                         width="272.8515625" height="200">
						<path d="M1396.363636 121.018182c0 0-223.418182 74.472727-484.072727 372.363636-242.036364 269.963636-297.890909 381.672727-390.981818 530.618182C512 1014.690909 372.363636 744.727273 0 549.236364l195.490909-186.181818c0 0 176.872727 121.018182 297.890909 344.436364 0 0 307.2-474.763636 902.981818-707.490909L1396.363636 121.018182 1396.363636 121.018182zM1396.363636 121.018182"
                    ...
                    <div class="pot-dialog-btns" :class="{'border-right-1px': isConfirm || isPrompt}">
                        <slot name="btns">
                            <a :href="_cancelBtn.href" class="pot-dialog-btn border-top-1px"
                               :class="{'pot-dialog-btn_highlight': _cancelBtn.active, 'pot-dialog-btn_disabled': _cancelBtn.disabled}"
                               v-if="isConfirm || isPrompt" @click="cancel">{{_cancelBtn.text}}</a>
                            <a :href="_confirmBtn.href" class="pot-dialog-btn border-top-1px"
                               :class="{'pot-dialog-btn_highlight': _confirmBtn.active, 'pot-dialog-btn_disabled': _confirmBtn.disabled}"
