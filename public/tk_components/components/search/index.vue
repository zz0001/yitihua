...
<template>
    <div @click="toSearch" class="tk-search">
        <div class="search">
            ...
            <div :class="{isFocus:isFocus||local.length}" class="input">
                <span class="glyphicon glyphicon-search"></span>
                <input ref="input" @focus="focus" @blur="blur" @keypress.enter="$emit('enter')" v-model="searchVal"
                       :placeholder="!this.local.length?placeholder:''" type="text"/>
                ...
                <div class="pot-scroll-contaienr">
                    <pot-scroll
                        ...
                        <ul class="tk-local">
                            <li @click="searchVal=item" :key="index" v-for="(item,index) of local"
                                class="tk-local-item">
