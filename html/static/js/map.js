/**
 * Created by 陈思燕 on 2016/12/1.
 */
window.BMap_loadScriptTime = (new Date).getTime();
window.BMAP_AUTHENTIC_KEY = "Yw2mqZKSLzXgd9SOcpRToNa16NFbaUXN";
(function () {
    function aa(a) {
        throw a;
    }
    ...
    x.D.tj = function (a, b) {
        ...
        if (!d)var e = c.EB[b], d = a.currentStyle || (x.ea.la ? a.style : getComputedStyle(a, p)), d = e && e.get ? e.get(a, d) : d[e || b];
    ...
    x.D.ha = function (a) {
        a = x.D.$(a);
        if (a === p)return a;
        var b = x.D.HD(a), c = x.ea, d = x.D.tj;
    ...
    x.extend(ib.prototype, {
        ...
        }, ha: t("Kb"), Rt: ba("Vg"), XD: t("Vg"), setUserData: ba("rJ"), getUserData: t("rJ")
    });
    function Sb() {
        this.C = p;
        this.Lb = "control";
    ...
    x.extend(hb.prototype, {
        Jm: function (a, b) {
            ...
            I.load("coordtrans", function () {
                var a = hc.RD(c.gj || "bj", d), a = new Q(a.x, a.y);
                b && b(a)
            }, o)
        }, pointToLngLatFor3D: function (a, b) {
            var c = this, d = new H(a.x, a.y);
            I.load("coordtrans", function () {
                var a = hc.QD(c.gj || "bj", d), a = new H(a.lng, a.lat), a = R.Eb(a);
                b && b(a)
            }, o)
        }, CQ: function (a, b) {
    ...
    x.extend(oc.prototype, {
        setPath: ba("kB"), setAnchor: function (a) {
    ...
    x.extend(Dc.prototype, {
        qa: function () {
            ...
            var a = this.map, b = a.oa(), c = b.cE(a.Ka), d = a.lc, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c), b = b.k.Ob, c = [e, f, (d.lng - e * c) / c * b, (d.lat - f * c) / c * b];
            return [c[0] - Math.ceil((a.width / 2 - c[2]) / b), c[1] - Math.ceil((a.height / 2 - c[3]) / b), c[0] + Math.ceil((a.width / 2 + c[2]) / b), c[1] + Math.ceil((a.height / 2 + c[3]) / b), c]
        }, k_: function (a, b, c, d) {
            var e = this;
            e.s1 = b;
            var f = this.map.oa(), g = e.YD(a, c), i = f.k.Ob, b = [a[0] * i + b[0], (-1 - a[1]) * i + b[1]], k = this.wg[g];
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (!i.ZH && !(i.mp && !this.map.Ub() || i.iM && this.map.Ub())) {
                    ...
                    var u = e.Bc(m), k = e.cE(m), l = Math.ceil(f.lng / k), v = Math.ceil(f.lat / k), w = e.k.Ob, k = [l, v, (f.lng - l * k) / k * w, (f.lat - v * k) / k * w], n = k[0] - Math.ceil((d.width / 2 - k[2]) / w), l = k[1] - Math.ceil((d.height / 2 - k[3]) / w), v = k[0] + Math.ceil((d.width / 2 + k[2]) / w), y = 0;
                    e === Oa && 15 == d.fa() && (y = 1);
    ...
    nb.prototype.getTilesUrl = function (a, b) {
        var c = a.x, d = a.y, e = this.oc, c = Oc[Math.abs(c + d) % Oc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.Wm + "&tags=" + e.eu + "&filter=" + e.filter + "&sortby=" + e.Hy + "&ak=" + this.oc.Sl + "&age=" + e.sw + "&page_size=" + e.qN + "&format=" + e.A_;
    ...
    Fe.prototype = {
        ...
        $u: function (a) {
            if (!(te && 0 !== a.touches.length)) {
                ...
                if (b.Wk)d = b.scale * b.op, d = Math.max(b.options.Vk, d), d = Math.min(b.options.Xp, d), b.op = d / b.scale, b.scale = d, b.x = b.dy - b.dy * b.op + b.x, b.y = b.ey - b.ey * b.op + b.y, b.Nb.style[ke] = "200ms", b.Nb.style[ie] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Ee, b.Wk = q, b.refresh(), b.options.up && b.options.up.call(b, a); else {
                    if (b.rh) {
    ...
    x.extend(Ge.prototype, {
        Lk: function (a) {
            ...
            this.Pc = G() ? new Fe(this.gk, {Bo: q, Vx: o, mi: q, Ci: q, vn: q, DE: o, Bw: o, zx: o}) : new Ke(this.gk)
        }, U: function () {
