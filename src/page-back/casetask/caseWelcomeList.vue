...
<div data-role="page" id="case_welcome_page">
    <div class="page_header">
        ...
        <div class="page_header_title">我的待办</div>
...
/*#case_welcome_page table tr:first-child td:first-child {*/
/*padding: 0.7em 0em 0.7em 0.5em;*/
/*line-height: 1.3em;*/
/*text-align: left;*/
/*}*/

/*#case_welcome_page table tr:last-child td {*/
/*padding:0em 0em 0.6em 0.5em;*/
/*line-height: 1.3em;*/
/*}*/

/*#case_welcome_page table tr:first-child td:last-child {*/
/*text-align: right;*/
...
/*#case_welcome_page table:last-child tr td:last-child {*/
...
.tab_bloack_font p,
#case_welcome_page .jszx-bar-item-2 div p {
    height: 2.8em;
    line-height: 2.8em;
}
