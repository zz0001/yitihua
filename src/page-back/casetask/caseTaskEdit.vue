<template>
    <div data-role="page" id="case_task_edit_page">
        ...
        <div class="page_header_title" id="taskedirtitle">工单处理</div>
    </div>
                ...
                <div class="html_margin white_background">
                    <table class="inp_table" cellpadding="0" cellspacing="0">
                        ...
                        <tr class="case_task_edit_people">
                            <td style="min-width: 5em;" class="">所属村/社区<span>*</span></td>
                            <td>
                                <input readonly id="case_task_edit_people" placeholder="请选择所属村/社区" type="text"/>
                            </td>
                    ...
                    <!--     <tr class="case_task_edit_addtime_tr">
                        ...
                        <!--<tr class="case_task_edit_address_tr">-->
                        <!--<td style="min-width: 5em;" class="">位置描述<span>*</span></td>-->
                        <!--<td id="case_task_edit_address"-->
                        <!--style="padding:1em;text-align: right;line-height: 1.3em;">-->
                        <!--&lt;!&ndash;<input readonly id="case_task_edit_address" type="text"&ndash;&gt;-->
                        <!--&lt;!&ndash;placeholder="请选择位置"/>&ndash;&gt;-->
                        <!--</td>-->
                        <!--<td style="width: 1%;" id="case_task_edit_address_img">-->
                    ...
                    <div style="line-height: 26px;">
                      <input id="smallarea" type="radio" value="0" name="area">小于<span class="currarea"></span></input>
                    </div>
                    <div style="line-height: 26px;">
                      <input id="bigarea" type="radio" value="1" name="area">大于<span class="currarea"></span></input>
                    </div>
                    </div>
                    <table class="inp_table" cellpadding="0" cellspacing="0">
                        <tr>
    ...
    export default {
        mounted(){
            ...
            /* 	if ((13 == parseInt(window.caseOneTaskAction.opValue) || 131 == parseInt(window.caseOneTaskAction.opValue) || 132 == parseInt(window.caseOneTaskAction.opValue) || 133 == parseInt(window.caseOneTaskAction.opValue) || 8 == parseInt(window.caseOneTaskAction.opValue)) && isNull(window.choiceDelayAddTime)) {
                ...
                if (window.caseOneTaskAction.opValue=="2"&&isNull(window.choiceThingsParts)) {
                    toast("请输入职能事项");
                }else if (window.caseOneTaskAction.opValue=="2"&&isNull(window.choiceBigType)) {
                    toast("请输入大类");
                }else if (window.caseOneTaskAction.opValue=="2"&&isNull(window.deptId)) {
                    toast("请选择所属村/社区");
                }
            ...
            switch (parseInt(window.caseOneTaskAction.opValue)) {
                case 1:
                   ...
                   // $("#case_task_edit_page .case_task_edit_addtime_tr").hide();
                    $("#case_task_edit_page .case_task_edit_people td:first-child").html("所属村/社区<span>*</span>");
                    $("#case_task_edit_page #case_task_edit_people").attr("placeholder", "请选择所属村/社区");
                    break;
                case 2:
        ...
        doPost("app_publicOpinion_attachmentUpload.action", obj, function (data) {
          ...
          function finddeptList() {
        	    ...
        	    doPost("deptList.action", obj, function (data) {
