<template>
    <div data-role="page" id="findzggj_main">
        ...
        <div class="page_content">
            <div class="html_margin white_background">
                <div id="findzggj_map" style="width: 100%;height:calc(100% - 150px);overflow: hidden;margin:0;"></div>
        ...
        <div class="page_footer">
            <div class="footer_button_div">
                ...
                <div>
                    <div id="find_findgj" class="alert_bottom_three blue_background">查看</div>
                </div>
            </div>
        </div>
        <div id="findtimearea" style="position: absolute;top:3em;width:100%;z-index: 900;display:none;">
            <table class="inp_table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td colspan="2" class="gray_line_bottom">
                        <input class="small gray_dark_font" style="color:#999999;" readonly="true"
                               placeholder="选择开始时间" id="find_zggj_start_time"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" class="gray_line_bottom">
                        <input class="small gray_dark_font" style="color:#999999;" readonly="true"
                               placeholder="选择结束时间" id="find_zggj_end_time"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <div id="find_findgj_area" class="alert_bottom_three blue_background">查询</div>
...
<script>
    export default {
        ...
        mounted() {
            ...
            /*返回*/
            $("#findzggj_main .back-button").listen("quickClick", function (e) {
                that.$router.back();
            });
            chooseDate("find_select_time", "datetime");
            chooseDate("find_zggj_start_time", "datetime");
            chooseDate("find_zggj_end_time", "datetime");
            $("#find_findgj").listen("quickClick", function (e) {
                window.showsome = "1";
                window.startTime = $("#find_select_time").val() + ":00";
                findzggj_locate();
            });

            $("#find_findgj_area").listen("quickClick", function (e) {
                var start = $("#find_zggj_start_time").val() + ":00";
                if ($("#find_zggj_start_time").val() == "") {
                    start = ""
                }
                var end = $("#find_zggj_end_time").val() + ":00";
