<template>
    <div class="handle-case">
        <tk-header>案件处理</tk-header>
        <tk-container class="handler-case-content-wrapper">
            <div class="handle-case-content">
                <div class="case-number-wrapper">
                    <div class="case-number-font case-number-title">案件编号：</div>
                    <div class="case-number-font case-number">{{caseNumber}}</div>
                </div>
                ...
                <div class="case-address-wrapper">
                    <img class="case-address-icon" src="../../../static/image/add_new_menu_item.png" alt=""/>
                ...
                <div class="case-handle-process">
                    ...
                    <div class="case-handle-process-list-wrapper">
                        <div class="case-handle-process-item" v-for="(item, index) in processList">
                ...
                this.$http.post(this.url, obj).then(res => {
                    if (res.code === undefined || res.code === '0') {
                        ...
                        if (detail !== null) {
                            ...
                            this._inputValue(this.caseFrom, detail.caseFrom);
                            this._inputValue(this.caseType, detail.caseType);
                            this._inputValue(this.casePerson, detail.casePerson);
                            this._inputValue(this.caseTime, detail.caseTime);
                            this._inputValue(this.reportPerson, detail.reportPerson);
                            this._inputValue(this.reportTime, detail.reportTime);
