...
function showContentAlert(content, nofun, yesfun, btnyesname) {
    ...
    var $alert_content = $(content_html).appendTo("body").hide();
    $(".max-alert").fadeIn(800);
...
function showSmallChoice(str1, str2, fun1, fun2) {
    console.log('static  showSmallChoice');
    var smallcontent_html = '<div class ="max-dialog max-alert more_choice_title">';
    smallcontent_html += ' <div class="titlealertup"><img class="more_choice_imgs" src="../../src/resources/images/more_title_up.png"/></div>';
    if (isNull(str2)) {
    ...
    smallcontent_html += ' </div>';
    smallcontent_html += '</div>';
    var $smallcontent_content = $(smallcontent_html).appendTo("body").hide();
    $(".max-alert").fadeIn(800);
...
function showUpdate(isshow) {
    ...
    var $alert_update = $(update_html).appendTo("body").hide();
    initScroll({
        "wrapper": "updatefirm",
        "dir": "y",
        "scrollBar": true
